...
public class WebPShell {
  ...
  @Autowired ValidateQuality validateQuality;

  @Autowired ValidateImage validateImage;

  @Autowired ValidateParams validateParams;

  @Autowired ConvertImage convertImage;
